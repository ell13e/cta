 ...
 */
function cta_register_image_sitemap_provider() {
    ...
    add_filter('wp_sitemaps_add_provider', 'cta_add_image_sitemap_provider', 10, 2);
}
add_action('init', 'cta_register_image_sitemap_provider');

/**
 * Add image sitemap provider
 */
function cta_add_image_sitemap_provider($provider, $name) {
...
add_filter('wp_sitemaps_posts_entry', 'cta_add_course_images_to_sitemap', 10, 3);
...
add_filter('wp_sitemaps_posts_entry', 'cta_add_event_images_to_sitemap', 10, 3);
