...
while (have_posts()) : the_post();
  ...
  if ($course) {
    ...
    $course_discount_active = ccs_is_course_discount_active($course->ID);
    $course_discount_percent = ccs_get_course_discount_percentage($course->ID);
    ...
    if ($course_discount_active && $course_discount_percent > 0) {
      if (!$course_requires_code) {
        ...
        $course_discounted_price = ccs_apply_course_discount($course->ID, floatval($original_price));
  ...
  if ($site_wide_active && $site_wide_discount_percent > 0) {
    ...
    $discounted_price = ccs_apply_site_wide_discount(floatval($original_price));
  ...
  $outcomes = $course ? ccs_get_outcomes($course->ID) : []; // Uses helper to parse textarea
    ...
    <div class="container">
      <div class="course-detail-grid">
        ...
        <div class="course-detail-main">
          ...
          if (!$section_heading) {
            $section_heading = ccs_safe_get_field('seo_default_section_heading', 'option', 'Event Overview');
          }
          ?>
