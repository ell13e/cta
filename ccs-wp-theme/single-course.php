 ...
 */
function ccs_shorten_accreditation($accreditation) {
 ...
 */
function ccs_shorten_accreditation_for_includes($accreditation) {
  if (empty($accreditation)) {
    return $accreditation;
  }
...
while (have_posts()) : the_post();
  ...
  $course_discount = ccs_get_course_discount(get_the_ID());
  $course_discount_active = ccs_is_course_discount_active(get_the_ID());
  $course_discount_percent = ccs_get_course_discount_percentage(get_the_ID());
  ...
  if ($course_discount_active && $course_discount_percent > 0 && $price) {
    if (!$requires_code) {
      ...
      $price = ccs_apply_course_discount(get_the_ID(), floatval($price));
  ...
  $site_wide_discount_percent = ccs_get_site_wide_discount_percentage();
  $site_wide_active = ccs_is_site_wide_discount_active();
  if ($site_wide_active && $site_wide_discount_percent > 0 && $price) {
    $site_wide_price = ccs_apply_site_wide_discount(floatval($original_price));
  ...
  $outcomes = ccs_get_outcomes(get_the_ID());
  ...
  <section class="group-hero-section" aria-labelledby="course-detail-heading">
    <div class="container">
      ...
      if ($custom_h1) {
        ...
        $h1_pattern = ccs_safe_get_field('seo_default_h1_pattern', 'option', '');
        if (!empty($h1_pattern)) {
      ...
      <div class="event-detail-hero-meta">
        ...
        <div class="event-detail-hero-meta-item">
          ...
          <span><?php echo esc_html(ccs_shorten_accreditation($accreditation)); ?></span>
        </div>
        <?php endif; ?>
      </div>
    </div>
    ...
    <div class="container">
      <div class="course-detail-grid">
        ...
        <div class="course-detail-main">
          ...
          if (!$section_heading) {
            $section_heading = ccs_safe_get_field('seo_default_section_heading', 'option', 'Course Overview');
          }
          ?>
            ...
            <div class="accordion-content" id="certification-content" aria-hidden="true">
              <div class="course-detail-certification">
                ...
                <div class="course-detail-certification-item">
                  ...
                  <div class="course-detail-certification-badge"><?php echo esc_html(ccs_shorten_accreditation($accreditation)); ?></div>
                </div>
                <?php endif; ?>
              </div>
            </div>
              ...
              <div class="course-detail-price-includes">
                ...
                <ul class="course-detail-price-includes-list">
                  ...
                  if ($accreditation && strtolower(trim($accreditation)) !== 'none') {
                    $includes[] = esc_html(ccs_shorten_accreditation_for_includes($accreditation)) . ' Accreditation';
                  }
