 ...
 */
function ccs_get_government_resources_for_articles() {
    return [
        [
 ...
 */
function ccs_create_articles_from_resources() {
 ...
 */
function ccs_add_auto_populate_articles_page() {
 ...
 */
function ccs_auto_populate_articles_page() {
    if (isset($_POST['ccs_create_articles']) && check_admin_referer('ccs_create_articles')) {
        $result = ccs_create_articles_from_resources();
    ...
    <div class="wrap">
        ...
        <form method="post" style="margin-top: 30px;">
            ...
            <p>
                <button type="submit" name="ccs_create_articles" class="button button-primary button-large">
                    Create Articles
                </button>
            </p>
            <p class="description">
