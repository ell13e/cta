...
(function() {
  ...
  function populatePage(course) {
    // Update page title
    const pageTitle = `${course.title} - ${formatDate(course.date)} | Continuity of Care Services`;
    document.title = pageTitle;
    
    // Update meta description
    const metaDescription = document.querySelector('meta[name="description"]');
    const descriptionText = `Book your spot for ${course.title} on ${formatDate(course.date)} at Continuity of Care Services. CQC-compliant, CPD-accredited training in Kent.`;
    if (metaDescription) {
