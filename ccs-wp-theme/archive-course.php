...
$categories = ccs_get_course_categories();
    ...
    <div class="container">
      ...
      <div id="courses-grid" class="courses-grid">
        <?php while ($courses->have_posts()) : $courses->the_post(); 
          ...
          $terms = function_exists('ccs_get_course_category_terms') ? ccs_get_course_category_terms(get_the_ID()) : get_the_terms(get_the_ID(), 'course_category');
